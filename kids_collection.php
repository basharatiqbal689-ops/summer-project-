...
// ✅ Category filter for Kids Collection
$result = mysqli_query($conn, "SELECT * FROM products WHERE category='Kids Collection'");
?>
...
<title>Kids Collection - BashiStore</title>
<style>
body {
...
.card p { color: #e91e63; font-weight: bold; }
button {
  background: #e91e63;
  color: #fff;
  border: none;
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $avg_rating = round($rating_data['avg_rating'],0); // round to nearest whole number
?>
