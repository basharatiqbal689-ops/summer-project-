...
// ✅ Category filter for Home and Living
$result = mysqli_query($conn, "SELECT * FROM products WHERE category='Home and Living'");
?>
...
<title>Home & Living - BashiStore</title>
<style>
body {
...
.card p { color: #b5651d; font-weight: bold; }
button {
  background: #8b4513;
  color: #fff;
  border: none;
